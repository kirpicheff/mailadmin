...
func InitDB(dsn string) {
	...
	// Отключаем строгий режим на время миграции, чтобы MariaDB не падала на "Incorrect string value"
	// Это позволяет успешно изменить структуру таблиц, даже если в данных есть мусор или двойная кодировка.
